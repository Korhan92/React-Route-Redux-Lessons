...
const rootReducer = combineReducers({userReducer,productReducer,myReducer})




const myStore = createStore(rootReducer,{userReducer:"Tommy",
productReducer:[{name:"Sonny",type:"Mp3 Player" }],
myReducer:"First Text"}); //create your store 
